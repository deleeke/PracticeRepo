...
def doRectsOverlap(rect1, rect2):
    for a, b in [(rect1, rect2), (rect2, rect1)]:
        ...
        if ((isPointsInsideRect(a.left, a.top, b)) or
        (isPointsInsideRect(a.left, a.bottom, b)) or
        (isPointsInsideRect(a.right, a.top, b)) or
        (isPointsInsideRect(a.right, a.bottom, b))):
            return True
    return False

def isPointsInsideRect(x, y, rect):
...
# set up the bouncer and the food data structures
foodCounter = 0
NEWFOOD = 40
FOODSIZE = 20
...
while True:
    ...
    # move the bouncer data structures
    ...
    # check if the bouncer has interesected with any food squares.
    for food in foods[:]:
